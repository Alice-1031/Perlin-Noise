Uses PerlinNoise module from the P5.js library to render particle simulation in real time, giving them smooth flowing movements. Particles change direction based on brightest pixel 
